...
if __name__ == "__main__":
    ...
    """editAction = QtGui.QAction('Edit Output Settings', main_window)
    #editAction.setShortcut('Ctrl+N')
    editAction.setStatusTip('Edit output settings')
    editAction.triggered.connect(run_settings)
    ...
    model.setData(output_index, "Example Output")
    ...
    tree_view.clicked.connect(clicked_element)
